...
local teams = {
	[0] = {
		objective = "Beat all groove mazafakas",
		name = "a Bloodz Member",
		color1 = Color(180, 0, 0),
		color2 = Color(180, 0, 0)
	},
	[1] = {
		objective = "Beat all bloodz mazafakas",
...
function MODE:HUDPaint()
    ...
    draw.SimpleText("MBattle | Gang Beatdown", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(200,110,0, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
